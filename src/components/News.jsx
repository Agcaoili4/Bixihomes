...
const articles = [
  {
    id: "project-1",
    title: "Rosedale Full Home Modernization",
    description:
      "A complete interior and exterior renovation focused on energy efficiency, premium finishes, and better family flow.",
    photo: images.newsPhoto1,
    location: "Calgary, AB",
    schedule: "Q2 2026",
    timeline: "14-16 weeks",
    details: [
      "Scope includes kitchen reconfiguration, basement redevelopment, and facade refinishing with weather-resilient materials.",
      "Mechanical and electrical upgrades are planned in parallel to reduce total downtime and maintain predictable progress.",
      "The project includes milestone quality checks and staged handovers so homeowners can follow each phase with confidence.",
    ],
  },
  {
    id: "project-2",
    title: "Smart Electrical Capacity Upgrade Program",
    description:
      "A structured upgrade path for older homes requiring safer load capacity, modern panels, and cleaner circuit design.",
    photo: images.newsPhoto2,
    location: "Airdrie, AB",
    schedule: "Q3 2026",
    timeline: "4-6 weeks",
    details: [
      "Assessment-first workflow identifies high-load zones and future-proofs the property for EV charging and modern appliances.",
      "Panel replacement and circuit balancing are completed with code-compliant documentation for insurance and resale confidence.",
      "Program includes post-install verification and homeowner guidance on safe usage and maintenance best practices.",
    ],
  },
  {
    id: "project-3",
    title: "Heritage Exterior Restoration Initiative",
    description:
      "Preserving character homes through envelope repair, custom trim work, and modern weatherproofing.",
    photo: images.newsPhoto1,
    location: "Mount Royal, AB",
    schedule: "Q4 2026",
    timeline: "8-10 weeks",
    details: [
      "Detailed exterior restoration plan combines heritage-friendly craftsmanship with modern protection systems.",
      "Custom carpentry and trim replacements are matched to original style while improving structural durability.",
      "Work sequencing is designed to minimize weather exposure and keep site operations clean and efficient.",
    ],
  },
  {
    id: "project-4",
